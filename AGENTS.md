...
5. **Update migrations** - Don't modify existing migrations, create new ones. However, during development on a feature branch *before merge*, it is acceptable to edit a migration that was introduced in that same branch.
